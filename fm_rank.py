...
if __name__ == "__main__":
    ...
    # create model
    model = FactorizationMachine(n_features=n_features, embedding_dim=args.embedding_dim)
    ...
    # write results
    save_results('./' + args.dataset + '_fm.txt', args, best_dev_score, test_score, dev_hit5, dev_hit10, test_hit5, test_hit10)
