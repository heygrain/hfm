...
from model import AttentionalFM
...
if __name__ == "__main__":
    ...
    # create model
    model = AttentionalFM(n_features=n_features, n_fields=n_fields, embedding_dim=args.embedding_dim)
    ...
    # write results
    save_results('./' + args.dataset + '_afm.txt', args, best_dev_score, test_score, dev_hit5, dev_hit10, test_hit5, test_hit10)
